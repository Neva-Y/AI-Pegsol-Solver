...
int main(int argc, char *argv[]) {
	...
	if( ai_run ){ 
		...
		// Open write file and intialising global variables
		...
		fprintf(writeFile, "STATS:\n");
		fprintf(writeFile, "Expanded nodes: %'d\nGenerated nodes: %'d\n", expanded_nodes, generated_nodes);
		fprintf(writeFile, "Solution Length: %d\n", solution_size);
		fprintf(writeFile, "Number of Pegs Left: %d\n", num_pegs( &(solution[solution_size]) ) );
		fprintf(writeFile, "Expanded/seconds: %d\n", (int)(expanded_nodes/cpu_time_used) );
		fprintf(writeFile, "Time (seconds): %f\n", cpu_time_used );
